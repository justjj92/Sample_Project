//
// Class10venuevenueIdsetlistsAPI.swift
//
...
open class Class10venuevenueIdsetlistsAPI {
    /**
     .
     ...
     */
    open class func getVenueSetlistsGET(venueId: String, p: Int? = nil, completion: @escaping ((_ data: SfmSetlists?,_ error: Error?) -> Void)) {
        getVenueSetlistsGETWithRequestBuilder(venueId: venueId, p: p).execute { (response, error) -> Void in
  ...
  "itemsPerPage" : 20
     ...
     */
    open class func getVenueSetlistsGETWithRequestBuilder(venueId: String, p: Int? = nil) -> RequestBuilder<SfmSetlists> {
