//
// Class10useruserIdeditedAPI.swift
//
...
open class Class10useruserIdeditedAPI {
    /**
     .
     ...
     */
    open class func getUserEditedSetlistsGET(userId: String, p: Int? = nil, completion: @escaping ((_ data: SfmSetlists?,_ error: Error?) -> Void)) {
        getUserEditedSetlistsGETWithRequestBuilder(userId: userId, p: p).execute { (response, error) -> Void in
  ...
  "itemsPerPage" : 20
     ...
     */
    open class func getUserEditedSetlistsGETWithRequestBuilder(userId: String, p: Int? = nil) -> RequestBuilder<SfmSetlists> {
