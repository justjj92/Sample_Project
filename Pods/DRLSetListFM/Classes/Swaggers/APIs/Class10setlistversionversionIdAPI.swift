//
// Class10setlistversionversionIdAPI.swift
//
...
open class Class10setlistversionversionIdAPI {
    /**
     .
     ...
     */
    open class func getSetlistVersionGET(versionId: String, completion: @escaping ((_ data: SfmSetlist?,_ error: Error?) -> Void)) {
        getSetlistVersionGETWithRequestBuilder(versionId: versionId).execute { (response, error) -> Void in
  ...
  "lastUpdated" : "2013-10-20T05:18:08.000+0000"
     ...
     - returns: RequestBuilder<SfmSetlist> 
     */
    open class func getSetlistVersionGETWithRequestBuilder(versionId: String) -> RequestBuilder<SfmSetlist> {
        ...
        let requestBuilder: RequestBuilder<SfmSetlist>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
